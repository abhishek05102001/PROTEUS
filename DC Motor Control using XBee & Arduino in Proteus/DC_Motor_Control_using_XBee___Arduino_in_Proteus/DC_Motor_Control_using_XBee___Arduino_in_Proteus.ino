...
void setup() 
{
  ...
  Serial.println();
  Serial.println("By Abhishek Rao and Ratnesh Yadav");
  Serial.println();
  Serial.println();
  Serial.println();
...
void loop() 
{
  if(Serial.available())
  {
    ...
    if(data == '2'){DataCheck = 1; digitalWrite(Motor3, LOW);digitalWrite(Motor4, HIGH); Serial.println("Second Motor is moving in Clockwise Direction.");}
    if(data == '3'){DataCheck = 1; digitalWrite(Motor1, LOW);digitalWrite(Motor2,  LOW); Serial.println("First Motor is Stopped");} 

    if(data == '4'){DataCheck = 1; digitalWrite(Motor1, LOW);digitalWrite(Motor2, HIGH); Serial.println("First Motor is moving in Anti-Clockwise Direction.");}
